...
function displayPics(){
  ...
  // line of code threw an error when we changed the letiable declaration from `const to `const`.
  // Because rando is not scoped as a global variable, it is inside the function displayPics.
  console.log(viewed);
